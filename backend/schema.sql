...
-- Execute: psql -h <RDS_HOST> -U techstock_user -d techstock -f schema.sql
...
INSERT INTO produtos (codigo, nome, descricao, categoria_id, unidade, quantidade, qtd_minima, preco_custo, localizacao) VALUES
  ('TI-001', 'Cabo USB-C 1m',       'Cabo de dados e carga USB-C', 1, 'un',  25, 10, 12.50, 'A1-01'),
  ...
  ('EL-001', 'Tomada 3 pinos',       'Tomada de embutir 10A',       2, 'un',  50, 20,  4.80, 'B2-01'),
  ...
  ('ES-002', 'Caneta azul cx50',     'Caixa c/ 50 canetas esf.',    3, 'cx',   7, 10, 18.50, 'C1-02'),
  ('FE-001', 'Chave Phillips #2',    'Chave de fenda Phillips',     4, 'un',  15,  5,  8.90, 'D1-01'),
